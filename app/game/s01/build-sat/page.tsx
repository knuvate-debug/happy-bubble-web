...
import { PhaserBuildSatGame } from "@/components/PhaserBuildSatGame";
import { getGamePackItem } from "@/game/data/gamePacks";

export default function S01BuildSatPage() {
  const game = getGamePackItem("s01", "build-sat");
  ...
  return (
    <GamePlayShell game={game}>
      <PhaserBuildSatGame sessionId="s01" />
    </GamePlayShell>
  );
}
